...
$dispatcher = FastRoute\simpleDispatcher(function (FastRoute\RouteCollector $r) {
    ...
    $r->addRoute('POST', '/teacher', ['IndexController', 'createTeacher']);
    $r->addRoute('POST', '/verify/teacher', ['IndexController', 'verifyTeacher']);
    $r->addRoute('POST', '/login/teacher', ['IndexController', 'createTeacherJWT']);
